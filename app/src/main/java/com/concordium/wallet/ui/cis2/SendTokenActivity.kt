...
class SendTokenActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        */
        ...
        Thumbnail("https://developer.concordium.software/en/mainnet/_images/wCCD.svg"),false, display = null, artifact = null, attributes = null, assets = null, localization = null), false, "1696", false, 1, 2000, "FT example")
        updateWithToken(viewModel.sendTokenData.token)
        initViews()
        viewModel.loadTransactionFee()
    }
