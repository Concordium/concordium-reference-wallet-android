...
class WalletConnectTransactionSubmittedFragment : Fragment() {
    ...
    companion object {
        @JvmStatic
        fun newInstance(viewModel: WalletConnectViewModel, walletConnectData: WalletConnectData) = WalletConnectTransactionSubmittedFragment().apply {
            arguments = Bundle().apply {
                putSerializable(WalletConnectViewModel.WALLET_CONNECT_DATA, walletConnectData)
            }
